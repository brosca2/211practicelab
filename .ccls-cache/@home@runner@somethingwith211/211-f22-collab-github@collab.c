...
void brosca2_rmann20()
{
  printf("Brian Rosca and Rishabh Manne\n");
  printf("We learned that GitHub is important in industry for things like pushing, pulling, and commit changes to a product\n");
  printf("Industry sees github as the mark that defines a companies possible push/pull productivity, seeing changes happen as soon as they are made through version control\n");
  printf("Oh, and did we say it's cloud-based?!?\n");
}
